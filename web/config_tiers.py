...
CONFIG_FIELD_REGISTRY: List[Dict[str, str]] = [
    ...
    {"path": "logic.per_id_video_source", "tier": TIER_USER, "group": "logic", "label": "单车录像画面来源"},
    ...
    {"path": "logic.class_thresholds.car", "tier": TIER_DEVELOPER, "group": "logic", "label": "车辆阈值"},
    {"path": "logic.class_thresholds.blue truck", "tier": TIER_DEVELOPER, "group": "logic", "label": "蓝色货车阈值"},
    {"path": "logic.class_thresholds.yellow truck", "tier": TIER_DEVELOPER, "group": "logic", "label": "黄色货车阈值"},
    {"path": "logic.class_thresholds.dump truck", "tier": TIER_DEVELOPER, "group": "logic", "label": "自卸车阈值"},
    {"path": "logic.class_thresholds.wuxiao", "tier": TIER_DEVELOPER, "group": "logic", "label": "无效目标阈值"},
    {"path": "logic.class_thresholds.wheel", "tier": TIER_DEVELOPER, "group": "logic", "label": "车轮阈值"},
    {"path": "logic.class_thresholds.cleaning table", "tier": TIER_DEVELOPER, "group": "logic", "label": "清洗台阈值"},
    {"path": "logic.class_thresholds.manual", "tier": TIER_DEVELOPER, "group": "logic", "label": "手动目标阈值"},
    {"path": "logic.class_thresholds.license", "tier": TIER_DEVELOPER, "group": "logic", "label": "车牌阈值"},
    {"path": "logic.vehicle_tracker_impl", "tier": TIER_DEVELOPER, "group": "logic", "label": "车辆跟踪器实现"},
    {"path": "logic.water_window_size", "tier": TIER_DEVELOPER, "group": "logic", "label": "水流窗口大小"},
    {"path": "logic.water_window_min_hits", "tier": TIER_DEVELOPER, "group": "logic", "label": "水流最小命中"},
    {"path": "logic.zone_a_margin_ratio", "tier": TIER_DEVELOPER, "group": "logic", "label": "Zone A 动态边界比例"},
    {"path": "logic.zone_a_margin_min_px", "tier": TIER_DEVELOPER, "group": "logic", "label": "Zone A 最小边界像素"},
    {"path": "logic.zone_a_margin_max_px", "tier": TIER_DEVELOPER, "group": "logic", "label": "Zone A 最大边界像素"},
    {"path": "logic.zone_a_observed_outside_hits", "tier": TIER_DEVELOPER, "group": "logic", "label": "Zone A 外部确认次数"},
    {"path": "logic.zone_a_enter_core_hits", "tier": TIER_DEVELOPER, "group": "logic", "label": "Zone A 核心进入次数"},
    {"path": "logic.zone_a_exit_outside_hits", "tier": TIER_DEVELOPER, "group": "logic", "label": "Zone A 外部退出次数"},
    {"path": "logic.copy_track_last_frame", "tier": TIER_DEVELOPER, "group": "logic", "label": "复制轨迹末帧"},
    {"path": "logic.copy_raw_frame_cache", "tier": TIER_DEVELOPER, "group": "logic", "label": "复制原始帧缓存"},
    {"path": "logic.per_id_video_queue_size", "tier": TIER_DEVELOPER, "group": "logic", "label": "单车录像队列大小"},
    {"path": "logic.shadow_plate_pool.color_window_frames", "tier": TIER_DEVELOPER, "group": "logic", "label": "颜色投票窗口"},
    {"path": "logic.shadow_plate_pool.color_switch_min_consecutive", "tier": TIER_DEVELOPER, "group": "logic", "label": "颜色切换连续帧"},
    {"path": "logic.shadow_plate_pool.color_switch_gain_ratio", "tier": TIER_DEVELOPER, "group": "logic", "label": "颜色切换领先比例"},
    {"path": "logic.shadow_plate_pool.color_switch_margin", "tier": TIER_DEVELOPER, "group": "logic", "label": "颜色切换边界"},
    {"path": "logic.shadow_plate_pool.text_switch_gain_ratio", "tier": TIER_DEVELOPER, "group": "logic", "label": "文本切换领先比例"},
    {"path": "logic.shadow_plate_pool.text_switch_margin_ratio", "tier": TIER_DEVELOPER, "group": "logic", "label": "文本切换边界比例"},
    {"path": "wheel.reader_stale_seconds", "tier": TIER_DEVELOPER, "group": "wheel", "label": "车轮画面过期秒数"},
    {"path": "wheel.reader_stale_check_interval_frames", "tier": TIER_DEVELOPER, "group": "wheel", "label": "车轮过期检查帧数"},
    {"path": "wheel.reader_stale_hash_size", "tier": TIER_DEVELOPER, "group": "wheel", "label": "车轮画面哈希尺寸"},
    ...
    {"path": "logic.event_plate_fast_lock_frames", "tier": TIER_DEVELOPER, "group": "logic", "label": "快速车辆车牌锁定帧数"},
    {"path": "logic.event_plate_fast_speed_threshold", "tier": TIER_DEVELOPER, "group": "logic", "label": "快速车辆像素速度阈值"},
    ...
    {"path": "logic.anchor_mode", "tier": TIER_DEVELOPER, "group": "logic", "label": "正式锚点策略"},
    {"path": "logic.anchor_shadow_compare", "tier": TIER_DEVELOPER, "group": "logic", "label": "H/D/L锚点调试对照"},
    {"path": "logic.anchor_legacy_flow_shift_ratio", "tier": TIER_DEVELOPER, "group": "logic", "label": "兼容锚点反向偏移"},
    {"path": "logic.anchor_history_size", "tier": TIER_DEVELOPER, "group": "logic", "label": "锚点轨迹长度"},
    {"path": "logic.anchor_direction_window", "tier": TIER_DEVELOPER, "group": "logic", "label": "方向判断窗口"},
    {"path": "logic.anchor_direction_min_points", "tier": TIER_DEVELOPER, "group": "logic", "label": "方向判断最少点数"},
    {"path": "logic.anchor_direction_consistency", "tier": TIER_DEVELOPER, "group": "logic", "label": "方向一致率"},
    {"path": "logic.anchor_direction_min_displacement_ratio", "tier": TIER_DEVELOPER, "group": "logic", "label": "方向最小位移比例"},
    {"path": "logic.anchor_direction_blend_frames", "tier": TIER_DEVELOPER, "group": "logic", "label": "方向锚点过渡帧"},
