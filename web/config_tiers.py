...
CONFIG_FIELD_REGISTRY: List[Dict[str, str]] = [
    ...
    {"path": "zones.direction_reference_edge", "tier": TIER_USER, "group": "zones", "label": "方向参考边"},
    ...
    {"path": "system.auto_restart_max_attempts", "tier": TIER_DEVELOPER, "group": "system", "label": "自动重启窗口最大次数"},
    {"path": "system.auto_restart_window_seconds", "tier": TIER_DEVELOPER, "group": "system", "label": "自动重启统计窗口秒数"},
    {"path": "system.auto_restart_backoff_seconds", "tier": TIER_DEVELOPER, "group": "system", "label": "自动重启初始退避秒数"},
    {"path": "system.auto_restart_backoff_max_seconds", "tier": TIER_DEVELOPER, "group": "system", "label": "自动重启最大退避秒数"},
