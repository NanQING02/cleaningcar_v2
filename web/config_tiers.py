...
CONFIG_FIELD_REGISTRY: List[Dict[str, str]] = [
    ...
    {"path": "wheel.run_mode", "tier": TIER_DEVELOPER, "group": "wheel", "label": "车轮运行模式"},
    {"path": "wheel.service_url", "tier": TIER_DEVELOPER, "group": "wheel", "label": "车轮服务地址"},
    {"path": "wheel.service_timeout_seconds", "tier": TIER_DEVELOPER, "group": "wheel", "label": "车轮服务超时秒数"},
