...
class GlobalVideoCleanupTests(unittest.TestCase):
    ...
    def test_config_manager_defaults_simplified_event_controls(self):
        with tempfile.TemporaryDirectory() as tmpdir:
            ...
            self.assertEqual(manager.logic["plate_yellow_green_min_hits_per_color"], 2)
    ...
    def test_web_config_registry_exposes_simplified_event_controls(self):
        ...
        self.assertIn("logic.plate_yellow_green_fusion_enabled", field_paths)
        self.assertIn("logic.plate_yellow_green_min_confidence", field_paths)
        self.assertIn("logic.plate_yellow_green_window_frames", field_paths)
        self.assertIn("logic.plate_yellow_green_min_hits_per_color", field_paths)
